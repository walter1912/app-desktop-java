...
public class BookHotel extends JFrame {
	...
	public BookHotel(String username) {
		...
		JLabel lblName = new JLabel("ĐẶT KHÁCH SẠN");
		lblName.setFont(new Font("Yu Mincho", Font.PLAIN, 20));
		lblName.setBounds(118, 11, 300, 53);
                lblName.setBackground(mainColor);
		contentPane.add(lblName);
                
                JLabel la2 = new JLabel("người dùng :");
		...
		contentPane.add(l1);
                ...
                JLabel lblId = new JLabel("Chọn khách sạn :");
		...
		contentPane.add(lblId);
                ...
                try{
                    ...
                    ResultSet rs = c.s.executeQuery("select * from travel.hotel");
                    while(rs.next()){
                ...
                JLabel la3 = new JLabel("Số người :");
		...
		JLabel la5 = new JLabel("Qua đêm / Không qua đêm :");
		la5.setBounds(35, 230, 200, 14);
		contentPane.add(la5);
                
                c2 = new Choice();
                c2.add("Qua đêm");
                c2.add("Không qua đêm");
                c2.setBounds(271, 230, 150, 30);
                add(c2);

                
		JLabel la6 = new JLabel("Bao gồm thức ăn :");
		...
		JLabel lblDeposite = new JLabel("Tổng chi phí :");
		lblDeposite.setBounds(35, 430, 200, 14);
		contentPane.add(lblDeposite);
		
		JLabel l5 = new JLabel();
		l5.setBounds(271, 430, 400, 14);
                l5.setForeground(Color.RED);
		contentPane.add(l5);
                
                try{

                    ResultSet rs = c.s.executeQuery("select * from travel.customer where username = '"+username+"'");
                    while(rs.next()){
                ...
                JButton b1 = new JButton("Kiểm tra giá");
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "select * from travel.hotel where hotel = '"+c1.getSelectedItem()+"'";
                                ...
                                if(rs.next()){
                                    ...
                                    if(persons * days > 0) {
                                        total += acprice.equals("Qua đêm") ? ac : 1;
                                        total += foodprice.equals("Có") ? food : 1;
                                        total += cost;
                                        total = total * persons * days;
                                        l5.setText(total+"  Đồng");
                                    }
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "insert into travel.bookhotel values('"+l1.getText()+"', '"+c1.getSelectedItem()+"', '"+t1.getText()+"', '"+t2.getText()+"', '"+c2.getSelectedItem()+"', '"+c3.getSelectedItem()+"', '"+l2.getText()+"', '"+l3.getText()+"', '"+l4.getText()+"', '"+total+"')";
                                c.s.executeUpdate(q1);
                                
	    			JOptionPane.showMessageDialog(null, "Khách sạn đã được đặt thành công");
		...
		contentPane.add(btnExit);
                ...
                getContentPane().setBackground(bgrColor);
	}
}