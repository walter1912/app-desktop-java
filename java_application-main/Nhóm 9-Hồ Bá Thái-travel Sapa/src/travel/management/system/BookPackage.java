...
//	}
	...
	public BookPackage(String username) {
		...
		JLabel lblName = new JLabel("ĐẶT GÓI DỊCH VỤ");
		...
		contentPane.add(l1);
                ...
                JLabel lblId = new JLabel("Chọn gói dịch vụ :");
		...
		contentPane.add(l5);
                ...
                try{
                    Conn c = new Conn();
                    try (ResultSet rs = c.s.executeQuery("select * from travel.customer where username = '"+username+"'")) {
                        while(rs.next()){
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "insert into travel.bookpackage values('"+username+"', '"+c1.getSelectedItem()+"', '"+t1.getText()+"', '"+l2.getText()+"', '"+l3.getText()+"', '"+l4.getText()+"', '"+cost+"')";
                                c.s.executeUpdate(q1);
                                
	    			JOptionPane.showMessageDialog(null, "Đặt gói dịch vụ thành công!");
                                setVisible(false);
                            }catch(Exception ee){
