...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run() {
        try {
            ...
            l2.setVisible(true);
            caption.setText("Eden Boutique Hotel & Spa");
            l2.add(caption);
            Thread.sleep(2800);
            l2.setVisible(false);
            l3.setVisible(true);
            caption.setText("Mimosa Hotel Sapa");
            l3.add(caption);
            l3.setVisible(true);
            Thread.sleep(2800);
            l3.setVisible(false);
            l4.setVisible(true);
            caption.setText(" Sapa Relax Hotel & Spa");
            l4.add(caption);
            Thread.sleep(2800);
            l4.setVisible(false);
            l5.setVisible(true);
            caption.setText("Sapa Vista Hotel ");
            l5.add(caption);
            Thread.sleep(2800);
            l5.setVisible(false);
            l6.setVisible(true);
            caption.setText("Pao's Sapa Leisure Hotel");
            l6.add(caption);
            Thread.sleep(2800);
            l6.setVisible(false);
            l7.setVisible(true);
            caption.setText("Bonjour Sa Pa Hotel");
            l7.add(caption);
            Thread.sleep(2800);
            l7.setVisible(false);
            l8.setVisible(true);
            caption.setText("Silk Path Grand Resort & Spa Sapa");
            l8.add(caption);
            Thread.sleep(2800);
            l8.setVisible(false);
            l9.setVisible(true);
            caption.setText("Phuong Nam Hotel");
            l9.add(caption);
            Thread.sleep(2800);
            l9.setVisible(false);
            l10.setVisible(true);
            caption.setText("KK Sapa Hotel");
            l10.add(caption);
            Thread.sleep(2800);
            l10.setVisible(false);
            l11.setVisible(true);
            caption.setText("Sau Meo Mountain View");
            l11.add(caption);
            Thread.sleep(2800);
    ...
    public CheckHotels() {
        ...
        Image i8 = i7.getImage().getScaledInstance(900, 600, Image.SCALE_DEFAULT);
        ...
        Image i11 = i10.getImage().getScaledInstance(900, 600, Image.SCALE_DEFAULT);
        ImageIcon i12 = new ImageIcon(i11);
        l5 = new JLabel(i12);
        l5.setBounds(0, 0, 900, 600);
        add(l5);
        l5.setVisible(false);

        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/hotel5.jpg"));
        Image i14 = i13.getImage().getScaledInstance(900, 600, Image.SCALE_DEFAULT);
        ...
        Image i23 = i22.getImage().getScaledInstance(900, 600, Image.SCALE_DEFAULT);
        ...
        Image i26 = i25.getImage().getScaledInstance(900, 600, Image.SCALE_DEFAULT);
        ImageIcon i27 = new ImageIcon(i26);
        l10 = new JLabel(i27);
        l10.setBounds(0, 0, 900, 600);
        add(l10);
        l10.setVisible(false);

        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/hotel10.jpg"));
        Image i29 = i28.getImage().getScaledInstance(900, 600, Image.SCALE_DEFAULT);
        ImageIcon i30 = new ImageIcon(i29);
        l11 = new JLabel(i30);
        l11.setBounds(0, 0, 900, 600);
        add(l11);
        l11.setVisible(false);
