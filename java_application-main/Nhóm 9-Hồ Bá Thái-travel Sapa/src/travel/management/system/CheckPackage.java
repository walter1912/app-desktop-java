...
public class CheckPackage extends JFrame{
    ...
    CheckPackage() {    
      ...
      setVisible(true);
      String[] package1 = new String [] {"package1.jpg", "GOLD PACKAGE", "6 ngày và 5 đêm", "Có phòng spa và bể bơi", "Tour du lịch trải nghiệm cùng người dân", "Đồ uống chào mừng khi đến", "Tiệc tự chọn hàng ngày", "Hướng dẫn leo núi Fanxiphang", "Hướng dẫn nói tiếng Anh", "ĐẶT NGAY", "Đặc biệt vào mùa đông ", "Chỉ 5000000 Đồng "};
       String [] package2 = new String [] {"package2.jpg", "SILVER PACKAGE", "4 ngày và 3 đêm", "Có phòng gym miễn phí", "Bữa sáng miễn phí", "Đồ uống chào mừng khi đến","Lửa trại đêm"," Du ngoạn cả ngày cùng đoàn du lịch"," Đi cáp treo"," ĐẶT NGAY "," Đặc biệt vào mùa đông "," Chỉ 3000000 Đồng "};
       String [] package3 = new String [] {"package3.jpg", "BRONZE PACKAGE", "6 ngày và 3 đêm", "", "Tham gia các câu lạc bộ trong khách sạn miễn phí", "Chào mừng đồ uống khi đến "," Tiệc tự chọn hàng ngày"," Nghỉ tại khách sạn 5 sao "," Bữa tối BBQ "," ĐẶT NGAY "," Đặc biệt vào mùa đông "," Chỉ 2000000 Đồng "};
