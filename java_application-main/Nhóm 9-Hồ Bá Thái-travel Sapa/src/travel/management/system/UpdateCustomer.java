...
public class UpdateCustomer extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UpdateCustomer frame = new UpdateCustomer("user5");
	...
	public UpdateCustomer(String username) throws SQLException {
		...
		JLabel lblName = new JLabel("CẬP NHẬT THÔNG TIN NGƯỜI DÙNG");
		lblName.setFont(new Font("Yu Mincho", Font.PLAIN, 20));
		lblName.setBounds(118, 11, 300, 53);
		contentPane.add(lblName);
                
                JLabel l3 = new JLabel("Người dùng :");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s7 =  t7.getText(); 
                                ...
                                String q1 = "update travel.customer set id_number ='"+s2+"' ,name = '"+s4+"', gender = '"+s5+"', country = '"+s6+"', address = '"+s7+"', phone = '"+s8+"', email = '"+s9+"' where username = '"+s1+"'";
	    			...
	    			System.out.println(e1.getMessage());
                                JOptionPane.showMessageDialog(null, "không được thay số thẻ(khóa chính)");
	    		}
		    		catch(NumberFormatException s){
		    			JOptionPane.showMessageDialog(null, "Vui lòng nhập đúng trường");
			}
			}
		});
