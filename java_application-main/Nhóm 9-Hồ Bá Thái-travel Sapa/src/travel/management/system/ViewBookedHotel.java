...
//	}
	...
	public ViewBookedHotel(String username)  {
		...
		JLabel lblName = new JLabel("KHÁCH SẠN ĐÃ ĐẶT");
		...
		contentPane.add(l2);
                ...
                JLabel lb2 = new JLabel("Số người :");
		...
		JLabel lblName_1 = new JLabel("Số ngày :");
		...
		JLabel lblGender = new JLabel("Qua đêm /Không qua đêm :");
		...
		JLabel lblCountry = new JLabel("bao gồm đồ ăn (Có/Không) :");
		...
		JLabel lblReserveRoomNumber = new JLabel("Thẻ :");
		...
		JLabel lblCheckInStatus = new JLabel("Số thẻ :");
		...
		JLabel lblDeposite = new JLabel("SĐT :");
		...
		contentPane.add(l10);
                ...
                try{
                    ...
                    ResultSet rs = c.s.executeQuery("select * from travel.bookhotel where username = '"+username+"'");
                    while(rs.next()){
