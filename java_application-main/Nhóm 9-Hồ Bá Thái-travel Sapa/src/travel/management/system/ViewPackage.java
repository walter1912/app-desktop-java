...
public class ViewPackage extends JFrame {
	...
	public ViewPackage(String username)  {
		...
		JLabel lblName = new JLabel("XEM GÓI DỊCH VỤ ĐÃ ĐẶT");
		...
		contentPane.add(l1);
                ...
                JLabel lblId = new JLabel("Loại gói :");
		...
		JLabel lblName_1 = new JLabel("Thẻ :");
		...
		JLabel lblGender = new JLabel("Số thẻ :");
		...
		JLabel lblCountry = new JLabel("SĐT :");
		...
		JLabel lblReserveRoomNumber = new JLabel("Giá :");
